...
1. **Inventory**
   ...
   |-------------|----------|-------------|-------------|----------|---------|
   | ai_ide | email (+ user id) | cycle total | daily | cycle start | usage backfill; spend snapshot-forward |
...
**Ask:** “We have AI IDE seats and a second AI gateway billed monthly per API key.”
...
4. Never diff a monthly invoice as if it were a cycle-cumulative seat API unless the math is written down
